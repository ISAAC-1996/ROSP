...
<div class="section-titles"><h2>Suivi des switchs </h2><h2>Princeps non substitués</h2></div>
    ...
    <tbody>
      ...
      if (!is.null(params$top_10) && nrow(params$top_10) > 0) {
        for (i in 1:nrow(params$top_10)) {
          cat('<tr>') 
          cat(paste0("<td>", capitalize_first(truncate_string(params$top_10[i, "Présentation"], 40)), "</td>"))
    ...
    <tbody>
      ...
      if (!is.null(params$top_5) && nrow(params$top_5) > 0) {
        for (i in 1:nrow(params$top_5)) {
          cat('<tr>') 
          cat(paste0("<td>", capitalize_first(truncate_string(params$top_5[i, "Présentation"], 20)), "</td>"))
          cat(paste0('<td>', capitalize_first(truncate_string(as.character(params$top_5[i, "Laboratoire"]), 17)), '</td>'))
